...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    <div
        class="flex flex-col w-full max-w-md px-4 py-8 bg-blue-100 rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
            ...
            <form action="{{ route('login') }}" autoComplete="off" method="POST">
                ...
                <div class="flex flex-col mb-2">
                    <div class="flex relative">
                        ...
                        <input type="text" id="sign-in-email" name="email"
                ...
                <div class="flex flex-col mb-6">
                    ...
                    @if (session('login_error'))
                        ...
                        <script>
                            console.error("{{ session('login_error') }}");
                        </script>
                    @endif
                </div>
                ...
                <div class="flex w-full">
                    <button type="submit"
                        class="py-2 px-4 bg-yellow-500 hover:bg-yellow-600 focus:ring-yellow-600 focus:ring-offset-yellow-600 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                        Login
                    </button>
                </div>
            </form>
