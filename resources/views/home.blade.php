                            ...
                            response.forEach(post => {
                                $('#post-container').append(`
                                    <div class="bg-white rounded-lg shadow post-item" data-post-id="${post.id}">
                                        <div class="p-4">
                                            <div class="flex items-center space-x-3">
                                                <img src="{{ asset('storage/') }}/${post.user.profile_picture}" alt="User" class="w-10 h-10 rounded-full">
                                                <div>
                                                    <div class="font-semibold">${post.user.name}</div>
                                            ...
                                            <p class="mt-3">${post.content}</p>
                                            ${post.image ? `<img src="{{ asset('storage/') }}/${post.image}" alt="Post Image" class="mt-3 rounded-lg">` : ''}
                                            <div class="mt-4 flex items-center space-x-4">
                                                <button class="flex items-center space-x-2 text-gray-500 hover:text-gray-700">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
